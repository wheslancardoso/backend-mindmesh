...
class DocumentIngestionServiceTest {
    ...
    void testReprocessDocumentRegeneratesChunks() throws IOException {
        ...
        List<DocumentChunk> originalChunks = documentChunkRepository.findByDocumentIdOrderByChunkIndexAsc(documentId);
        ...
        List<DocumentChunk> newChunks = documentChunkRepository.findByDocumentIdOrderByChunkIndexAsc(documentId);
    ...
    void testDeleteDocumentRemovesChunksAlso() throws IOException {
        ...
        UUID userId = UUID.randomUUID();
        byte[] bytes = loadResource("sample.txt");
        UUID documentId = documentIngestionService.ingestDocument(userId, "para_deletar.txt", "text/plain", bytes);
        ...
        List<DocumentChunk> chunksAntes = documentChunkRepository.findByDocumentIdOrderByChunkIndexAsc(documentId);
        ...
        List<DocumentChunk> chunksDepois = documentChunkRepository.findByDocumentIdOrderByChunkIndexAsc(documentId);
